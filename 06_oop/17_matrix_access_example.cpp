...
{
public:
    some_matrix() : nrows{0}, ncols{0}, data{nullptr} {}
    some_matrix(size_t nrows, size_t ncols) : nrows{nrows}, ncols{ncols}, data{new double[nrows * ncols]} {}
...
int main()
{
    ...
    std::cout << "A is \n" << A << std::endl;
    std::cout << "A[0][1] is " << A[0][1] << std::endl;

    const some_matrix B(A);
    std::cout << "B[0][1] is " << B[0][1] << std::endl;
