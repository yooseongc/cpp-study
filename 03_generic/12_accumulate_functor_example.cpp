...
int main(int argc, char* argv[])
{
    ...
    cout << "product l [empty] is " << accumulate(l.begin(), l.end(), 1.0f, times()) << '\n';
    cout << "max l [empty] is " << accumulate(l.begin(), l.end(), -numeric_limits<float>::max(), maximum()) << '\n';
    ...
    cout << "sum l is " << accumulate(l.begin(), l.end(), 0.0f, add<float>()) << '\n';
