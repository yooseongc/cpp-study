...
class vector
{
    public:
        ...
        friend int size(const vector& x)
        {
            return x.my_size;
        }
...
template <typename T>
inline T clone(const T& x) noexcept(std::is_nothrow_constructible<T>::value)
{
